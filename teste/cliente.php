...
<html>
    ...
    <body>
        ...
        <div class='row justify-content-left'>
                    ...
                    <form name="cliente" id="cadcliente" action="cadcliente.php" method="post">
                                <label >Nome</label> 
                                <input type="text" name="nome" placeholder="Digite o nome do cliente" maxlength="30" autofocus required="required" class="form-control" />
                                <br/>
                                <label>CPF</label> 
                                <input type="text" name="cpf_pessoa" placeholder="Digite o CPF" maxlength="11"  required="required" class="form-control" />
                                <br/>
                                <label>Status</label>
                                ...
                                <br/>
                                <label>Renda</label> 
                                <input type="text" name="renda" placeholder="Digite a renda do cliente" maxlength="30"  required="required" class="form-control" />
                                <br/>
                                <label>Credito</label> 
                                <input type="text" name="credito" placeholder="Digite o credito" maxlength="30"  required="required" class="form-control" />
                                <br/>
                                <label>Login</label> 
                                <input type="text" name="login" placeholder="Digite o login/username do cliente" maxlength="30"  required="required" class="form-control" />
                                <br/>
                                <label>Senha</label> 
    ...
    <div class="container">
        <?php
            ...
            echo "<tr>";
                ...
                echo "<td>
                <a href='editacliente.php?id=$id'><svg width='2em' height='2em' viewBox='0 0 16 16' class='bi bi-pencil-square' fill='currentColor' xmlns='http://www.w3.org/2000/svg' style='fill: #f0db56;'>
                    <path d='M15.502 1.94a.5.5 0 0 1 0 .706L14.459 3.69l-2-2L13.502.646a.5.5 0 0 1 .707 0l1.293 1.293zm-1.75 2.456l-2-2L4.939 9.21a.5.5 0 0 0-.121.196l-.805 2.414a.25.25 0 0 0 .316.316l2.414-.805a.5.5 0 0 0 .196-.12l6.813-6.814z'/>
                    <path fill-rule='evenodd' d='M1 13.5A1.5 1.5 0 0 0 2.5 15h11a1.5 1.5 0 0 0 1.5-1.5v-6a.5.5 0 0 0-1 0v6a.5.5 0 0 1-.5.5h-11a.5.5 0 0 1-.5-.5v-11a.5.5 0 0 1 .5-.5H9a.5.5 0 0 0 0-1H2.5A1.5 1.5 0 0 0 1 2.5v11z'/>
                </svg></a>
                </td>
                <td>
                <a href='apagacliente.php?id=$id'><svg width='2em' height='2em' viewBox='0 0 16 16' class='bi bi-trash' fill='currentColor' xmlns='http://www.w3.org/2000/svg' style='fill:  #f74343;'>
